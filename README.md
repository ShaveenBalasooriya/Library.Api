...
- [List any completed bonus items here, e.g. global exception handling middleware, DataAnnotations validation via endpoint filters, EF Core seed data via entity configurations]
